        ...
        <div class="container-fluid py-4">
            ...
            <div class="row my-4">
                <div class="col-lg-12 col-md-8 mb-md-0 mb-7">
                    <div class="card">
                        <form action="/cruzdepiedra/actividades/{{ $actividad->id }}" method="POST">
                            @method('PUT')
                            @csrf
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="titulo" class="form-control" id="basic-url"
                                                aria-describedby="basic-addon3" value="{{ $actividad->titulo }}"
                                                required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="form-control-label" for="basic-url">Descripcion de la
                                            actividad:</label>
                                        <div class="input-group">
                                            <textarea class="form-control" placeholder="Predica el Padre Tino (aprovecha para encomendarle la actividad)"
                                                name="descripcion" aria-label="With textarea"
                                            ...
                                            <div class="col">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="date" name="FechaInicio"
                                                        value="{{ $actividad->FechaInicio }}" id="example-date-input"
                                                        required>
                                                </div>
                                            </div>
                                            <div class="col">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" name="horaInicio" type="time"
                                                        value="{{ $actividad->horaInicio }}" id="example-time-input"
                                                        required>
                                                </div>
                                            </div>
                                            <div class="col">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="date" name="FechaFin"
                                                        value="{{ $actividad->FechaFin }}" id="example-date-input"
                                                        required>
                                                </div>
                                            </div>
                                            <div class="col">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="time" name="horaFin"
                                                        value="{{ $actividad->horaFin }}" id="example-time-input"
                                                        required>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="col">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" name="tipo[]"
                                                            ...
                                                            @if ($actividad->tipo == 'convivencia')
                                                                <option value="convivencia">Convivencia</option>
                                                                <option value="retiro">Retiro</option>
                                                                <option value="otros">Otros</option>
                                                            @elseif($actividad->tipo == 'retiro')
                                                                <option value="retiro">Retiro</option>
                                                                <option value="convivencia">Convivencia</option>
                                                                <option value="otros">Otros</option>
                                                            @else
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <input type="text" name="precio"
                                                                value="{{ $actividad->precio }}" placeholder="18000"
                                                ...
                                                <div class="col">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" name="director[]"
                                                            ...
                                                            @if ($actividad->director == null)
                                                                <option value="">
                                                                    Seleccionar Director</option>
                                                            @else
                                                                @foreach ($directores as $director)
                                                                    @if ($actividad->director == $director->id)
                                                                        <option value="{{ $actividad->director }}">
                                                ...
                                                <div class="col">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" name="subDirector[]"
                                                            id="exampleFormControlSelect1">
                                                            @if ($actividad->subDirector == null)
                                                                <option value="">
                                                                    Seleccionar SubDirector</option>
                                                            @else
                                                                @foreach ($directores as $director)
                                                                    @if ($actividad->subDirector == $director->id)
                                                                        <option value="{{ $actividad->subDirector }}">
                                                                            {{ $director->name }}</option>
                                                                    @endif
                                                                @endforeach
                                                            @endif
